                ...
                <div class="card border-0">
                    ...
                    @csrf
                        ...
                        <div class="fomr-group row pt-2">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control" placeholder="{{$autoId}}" name="regCode" readonly>
                            </div>
                        </div>  
                        <div class="fomr-group row pt-2">
                            <label for="" class="col-sm-5 col-form-label labelText">Region Name</label>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" placeholder="Ex. REGION 1" name="regName" required>
                            </div>
                        </div>  
